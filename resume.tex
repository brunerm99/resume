...
{Broomfield, CO}
{
  ...
  {\boldblue{Worked with customers} from the design specification phase through shipment and support phases},
  {Simulated, designed, and tested an RF Front-End PWB at extreme temperatures},
  {Schematic capture and layout of RF T/R systems (RF, digital, power), 
...
{Mar 2023}
{{\boldblue{Developed a conference presentation on FMCW radar} and corresponding software for the 2022 AESS Radar Bootcamp}}
...
{May 2021}
{
  ...
  {\boldblue{Created teaching documentation} for a 5G transmitter and receiver for FR1 and FR2 frequency bands},
...
\vspace{-0.2cm}
\skill{Communication}
{Excellent \boldblue{Technical Communication and Presentation Skills}, Experience \boldblue{Presenting PDR/CDRs}, \boldblue{Technical Paper/Presentation Formatting}, Concise Code Documentation}
\skill{Languages}
...
{Git, \LaTeX, Linux, Docker, PostGreSQL, Flask, Celery}
