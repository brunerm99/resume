...
{Broomfield, CO}
{
  ...
  {\boldblue{Schematic capture and layout} of RF T/R systems (RF, digital, power), 
...
{Mar 2023}
{{Developed a presentation on FMCW radar and corresponding software for the 2022 AESS Radar Bootcamp}}
...
\vspace{-0.2cm}
\skill{Languages}
{\boldblue{Python}, Rust, C, Bash, SQL, Matlab, NuShell, JavaScript, HTML, CSS}
\skill{Design / Simulation Tools}
{\boldblue{KiCad}, AWR Microwave Office, HFSS, \boldblue{AutoCAD}, QucsStudio, LTSpice, Cadence Virtuoso}
\skill{Technologies / Tools}
{\boldblue{Git}, \LaTeX, Linux, Docker, PostGreSQL, Flask, Celery}
\skill{Communication}
{Excellent \boldblue{Technical Communication and Presentation Skills}, Experience Presenting PDR/CDRs, \boldblue{Technical Paper/Presentation Formatting}, Concise Code Documentation}
