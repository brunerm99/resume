...
{Jan 2021}
{May 2022}
{Graduate Research Assistant | \boldblue{Thesis focused on Radar}}
{Fort Collins, CO}
{
...
\vspace{-0.2cm}
\skill{Languages}
{\boldblue{Python}, \boldblue{Rust}, \boldblue{C}, Bash, SQL, Matlab, NuShell, JavaScript}
\skill{Design / Simulation Tools}
{AWR Microwave Office, HFSS, KiCad, AutoCAD, QucsStudio, LTSpice, Cadence}
\skill{Technologies / Tools}
{\boldblue{Git}, \boldblue{Numpy}, Pandas, \boldblue{Scipy}, Benchtop measurement equipment, \LaTeX, Linux}
\skill{Communication}
