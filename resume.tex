...
{Broomfield, CO}
{
  {\boldblue{Built an embedded webpage} to control and monitor a phased array antenna},
  ...
  {\boldblue{Debugged firmware, hardware, and software} of complex, mission-critical RF boards under strict time constraints},
  {\boldblue{Firmware, software, and hardware I designed is currently in real-world deployment}},
...
{Fort Collins, CO}
{
  {Built a server to host and display real-time / historical radar data using PostGreSQL, Flask, \boldblue{Python}},
  {Design, schematic, and layout of a modular, X-band, FMCW drone radar},
  {\boldblue{Signal processing} / data visualization for Analog Device’s FMCW Phaser Board},
...
{Greeley, CO}
{
  ...
  {\boldblue{Helped develop firmware} for a large weather radar system}
}
...
\vspace{-0.2cm}
\skill{Languages}
{\boldblue{Python}, \boldblue{C}, Rust, Bash, SQL, NuShell, \boldblue{Matlab}, JavaScript}
\skill{Technologies / Tools}
{\boldblue{Git}, \boldblue{Linux}, Docker, PostGreSQL, SQLite, Pandas, Numpy, Flask, Celery}
\skill{Communication}
