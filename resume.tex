...
{Jun. 2021}
{Present}
{RF Engineer, Intern, Technical Aide}
{Broomfield, CO}
{{Simulated, designed, and tested an RF Front-End PWB at extreme temperatures},
  ...
  {Helped coworkers finish schematic and layout for their PWB’s},
...
{Lab Assistant}
{Greeley, CO}
{{Built a real-time radar display to easily display and animate radar data},{Performed characterizations and measurements of radar equipment},{Wrote firmware for an ARM-Cortex PSOC}}
...
\skill{Languages}
{Python, C, SQL, Bash, Matlab, JavaScript}
\skill{Technologies / Tools}
{Git, \LaTeX, Linux, Docker, PostGreSQL/TimescaleDB, Flask, Benchtop measurement equipment}
