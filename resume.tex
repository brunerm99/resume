...
{Fort Collins, CO}
{
  ...
  {\boldblue{Signal processing / data visualization} for an FMCW radar board},
...
{Greeley, CO}
{
  ...
  {Built a server to host and display real-time and historical \boldblue{geospatial radar data} using \boldblue{PostGreSQL}, Flask, \boldblue{Python}}
...
\vspace{-0.2cm}
\skill{Languages}
{\boldblue{Python}, Rust, C, Bash, \boldblue{SQL}, Matlab, NuShell, JavaScript}
% \skill{Design / Simulation Tools}
% {AWR Microwave Office, HFSS, KiCad, AutoCAD, QucsStudio, LTSpice, Cadence}
\skill{Technologies / Tools}
{Git, \LaTeX, Linux, Docker, \boldblue{PostGreSQL}, \boldblue{Plotly}, Flask, Celery}
\skill{Communication}
{Worked with customers through pre- and post-sales phases, Experience Presenting PDR/CDRs, Technical Presentation Formatting}
