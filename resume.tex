...
{Fort Collins, CO}
{
  {\boldblue{Signal processing / data visualization} for Analog Device’s FMCW Phaser Radar},
...
{Benchtop measurement equipment, Numpy, Pandas, Scipy, Git, \boldblue{ARM}, Linux}
\skill{Communication}
