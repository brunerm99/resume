...
{Broomfield, CO}
{
  ...
  {Schematic and layout of RF T/R systems (RF, digital, power), 
  antenna range test equipment, component testing coupons, etc.},
...
\vspace{-0.2cm}
\skill{Languages}
{Python, C, Bash, SQL, Matlab, JavaScript, HTML, CSS}
\skill{Design / Simulation Tools}
{KiCad, AWR Microwave Office, HFSS, QucsStudio, LTSpice, Cadence Virtuoso}
