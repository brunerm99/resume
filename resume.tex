...
{Broomfield, CO}
{
  ...
  {Built data analysis and visualization tools in Python},
  {Built a \boldblue{TCP/IP embedded webpage to control phased array electronics}},
...
{Git, Numpy, Pandas, Scipy, Benchtop measurement equipment, \LaTeX, Linux}
\skill{Communication}
