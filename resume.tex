...
{Broomfield, CO}
{
  {Built data visualization and analysis tools in \boldblue{Python}},
...
{Fort Collins, CO}
{
  {Built a server to host and display real-time / historical radar data using PostGreSQL, \boldblue{Flask}, \boldblue{Python}},
...
{Present}
{
  ...
  {Dashboard using Plotly Dash and a \boldblue{Flask} API},
  {\boldblue{CI/CD} setup}
}
{}
...
\vspace{-0.2cm}
\skill{Languages}
{\boldblue{Python}, C, Rust, Bash, SQL, NuShell, Matlab, JavaScript}
\skill{Technologies / Tools}
{\boldblue{Git}, \boldblue{Linux}, Docker, PostGreSQL, SQLite, Pandas, Numpy, \boldblue{Flask}, Celery, \boldblue{PyTest}}
\skill{Communication}
