...
\newcommand{\school}[7]{
  ...
  \begin{tabularx}{\textwidth}{
    ...
    \textbf{#1} & \textit{#7} \\
    \textit{#2} \textemdash \  \textbf{\textit{GPA: #3}}  \\
    \textit{#6} \\
...
\section*{EXPERIENCE}
\job{BAE Systems | DoD Clearance}
{Jun 2021}
{Jul 2023}
{RF Engineer}
{Westminster, CO}
{
  {System design, schematic, layout of 2D Active Phased Array Weather Radar},
  {Large scale phased array systems analysis (\boldblue{Python}, Matlab)},
  {Acted as a consultant for weather radar proposals}
}
\job{Ball Aerospace | DoD Clearance}
{Jun 2021}
{Jul 2023}
{RF Engineer}
{Westminster, CO}
{
  ...
  {Built \boldblue{data visualization and analysis tools in Python}},
...
{Greeley, CO}
{
  {Built a real-time radar display to \boldblue{easily display and animate radar data}},
  {Built a server to \boldblue{host and display real-time and historical radar data using PostGreSQL, Flask, Python}},
  {Performed characterizations and measurements of radar equipment}
}
\job{Colorado State University | ECE Department}
{Aug 2020}
{Dec 2020}
{Learning Assistant}
{Fort Collins, CO}
{
  {\boldblue{Helped students understand electrical engineering fundamentals}},
  {Wrote exam/homework questions to test understanding of core concepts}
}
\job{Engineering Technology Services}
{Dec 2018}
{May 2020}
{Lab Assistant}
{Fort Collins, CO}
{
  {Built operating system images for mass deployment across the network of engineering workstations},
  {Managed \$300,000 in lab equipment for engineering network of 240 workstations and devices},
  {Maintained a 98\% average customer rating for lab development, advanced support, and operational quality}
}
...
\section*{PROJECTS}
\project{Animated RF and Radar Educational Videos}
{Aug 2023}
{Present}
{
  {\boldblue{Made high-quality animations using Manim} to teach others about Radar and RF engineering},
  {Videos available at \href{https://www.youtube.com/@MarshallBrunerRF}{@MarshallBrunerRF} on YouTube},
  {"What is FMCW Radar and why is it useful?" - Completed},
  {"But how do you actually build an FMCW Radar?" - Finalizing Animations}
}
{}
\projectsingle{FMCW Radar Bootcamp}
{Mar 2023}
{{Developed \boldblue{signal processing software and a presentation for an FMCW radar} to present at the 2022 AESS Radar Bootcamp}}
{https://radar2023.ieee-radarconf.org/radar-boot-camp}
\project{Algorithmic Stock Trading Server}
{Aug 2022}
{Present}
{
  {Task scheduling system (backfilling data into PostGreSQL database, computing custom indicators, run entry / exit strategy)},
  {Containerized using docker},
  {Command-line interface for checking status, getting recent trades, etc.},
  {\boldblue{Analysis / forecasting using Pandas, Numpy, PyTorch}},
  {Discord bot for general notifications / monitoring},
  {Dashboard using Plotly Dash and a Flask API}
}
{}
...
{Present}
{
  {\href{https://github.com/nushell/nushell}{NuShell} | A new type of shell},
  {\href{https://github.com/pola-rs/polars}{Polars} | Dataframes powered by a multithreaded, vectorized query engine, written in Rust}
}
{}
...
{Nov 2020}
{Dec 2020}
{{Designed a radar clutter filter using machine learning}}
...
\vspace{-0.2cm}
\skill{Languages}
{\boldblue{Python}, Rust, C, Bash, SQL, Matlab, NuShell, JavaScript}
